...
os.system('clear')
time.sleep(3)
print("\033[36mIni bukan tentang siapa yg lebih pintar")
time.sleep(3)
print("\033[36mAtau soal siapa yang jadi leader")
time.sleep(3)
print("\033[36mtapi tentang tangan siapa yg mau saling menggenggam")
time.sleep(3)
print("\033[36mmerapatkan barisan dalam berjuang")
time.sleep(3)
print("\033[36mtanpa peduli aku siapa dan posisiku apa?")
time.sleep(3)
print("\033[36mDunia ini anonim bahkan kau hrs siap untuk tak dikenal")
time.sleep(3)
print("\033[36mbersembunyi dibalik topeng kegelapan")
time.sleep(3)
print("\033[36mnamun tangannya membaea pelita secercah harapan")
time.sleep(3)
