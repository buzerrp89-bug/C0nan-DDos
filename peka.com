...
time.sleep(3)
print("\033[36mtanpa peduli akan siapa dia lalu apa titelnya")
time.sleep(3)
print("\033[36mberani utk tidak dikenal bahkan tanpa nama")
time.sleep(3)
print("\033[36myang jelas...")
time.sleep(3)
print("\033[36mDia tak rela melihat saudaranya di tindas")
time.sleep(3)
print("\033[36mdlm kebiadaban GENOSIDA tanpa batas")
time.sleep(5)
attemps = 0
os.system('clear')
logo = """
