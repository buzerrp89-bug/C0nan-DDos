...
os.system('clear')
time.sleep(3)
print("\033[36m👉 Ini bukan tentang siapa yg lebih pintar")
time.sleep(3)
print("\033[36m👉 Atau soal siapa yang jadi leader")
time.sleep(3)
print("\033[36m👉 tapi tentang tangan siapa yg mau saling menggenggam")
time.sleep(3)
print("\033[36m👉 merapatkan barisan dalam berjuang")
time.sleep(3)
print("\033[36m👉 tanpa peduli aku siapa dan posisiku apa?")
time.sleep(3)
print("\033[36m👉 Ini Dunia anonim bahkan kau hrs siap untuk tak dikenal")
time.sleep(3)
print("\033[36m👉 bersembunyi dibalik topeng kegelapan")
time.sleep(3)
print("\033[36m👉 namun tangannya membaea pelita secercah harapan")
time.sleep(3)
print("\033[36m👉 mengenai hidup layak dan berkeadilan")
time.sleep(3)
print("\033[36m💥 PALESTINA.....!!")
time.sleep(3)
print("\033[36m👉 Kami tak rela engkau selalu dlm bayang² GENOSIDA")
time.sleep(15)
attemps = 0
os.system('clear')
logo = """
